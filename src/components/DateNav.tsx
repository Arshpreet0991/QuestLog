...
function DateNav() {
  ...
  return (
    <>
      <div className="flex items-center justify-center p-1 bg-amber-950 rounded-sm ... transition-all duration-300 shadow-[0_0_15px_5px_rgba(255,215,0,0.3)] cursor-pointer">
        <button
